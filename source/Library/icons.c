...
BOOL LIBFUNC L_WriteIcon(
	REG(a0, char *name),
	REG(a1, struct DiskObject *icon),
...
void LIBFUNC L_GetIconPosition(
	REG(a0, struct DiskObject *icon),
	REG(a1, short *x),
	REG(a2, short *y))
{
...
void LIBFUNC L_SetIconPosition(
	REG(a0, struct DiskObject *icon),
	REG(d0, short x),
	REG(d1, short y))
{
