...
APTR REGARGS OpenAsync(const STRPTR fileName, UBYTE accessMode, LONG bufferSize);
LONG REGARGS CloseAsync(APTR file);
LONG REGARGS ReadAsync(APTR file, APTR buffer, LONG numBytes);
