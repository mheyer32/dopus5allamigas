...
// Copy a button
Cfg_Button *LIBFUNC L_CopyButton(
	REG(a0, Cfg_Button *orig),
	REG(a1, APTR memory),
	REG(d0, short type))
{
	Cfg_Button *button;
...
// Copy a filetype
Cfg_Filetype *LIBFUNC L_CopyFiletype(
	REG(a0, Cfg_Filetype *orig),
	REG(a1, APTR memory))
{
	Cfg_Filetype *type;
...
// Copy a function
Cfg_Function *LIBFUNC L_CopyFunction(
...
Cfg_ButtonFunction *LIBFUNC L_CopyButtonFunction(
