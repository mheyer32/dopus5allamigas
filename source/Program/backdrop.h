...
BackdropObject *backdrop_leave_out(BackdropInfo *info, char *name, ULONG flags, short, short);
...
enum { BSORT_NORM, BSORT_HORIZ, BSORT_NAME, BSORT_TYPE, BSORT_SIZE, BSORT_DATE };
