...
#define Config_ListerButtons(__p0, __p1, __p2, __p3, __p4, __p5, __p6) \
	LP7(66, ULONG , Config_ListerButtons, \
		char *, __p0, a0, \
		IPCData *, __p1, a1, \
		IPCData *, __p2, a2, \
		struct Screen *, __p3, a3, \
		Cfg_ButtonBank *, __p4, a4, \
		ULONG , __p5, d0, \
		LONG , __p6, d1, \
		, CONFIGOPUS_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define Config_EditFunction(__p0, __p1, __p2, __p3, __p4, __p5) \
	LP6(90, Cfg_Function *, Config_EditFunction, \
		IPCData *, __p0, a0, \
		IPCData *, __p1, a1, \
...
#define Config_Buttons(__p0, __p1, __p2, __p3, __p4) \
	LP5(48, int , Config_Buttons, \
		ButtonsStartup *, __p0, a0, \
		IPCData *, __p1, a1, \
		IPCData *, __p2, a2, \
		struct Screen *, __p3, a3, \
		ULONG , __p4, d0, \
...
#define FunctionExportASCII(__p0, __p1, __p2, __p3) \
	LP4(102, BOOL , FunctionExportASCII, \
		char *, __p0, a0, \
		Cfg_Button *, __p1, a1, \
...
#define Config_Settings(__p0, __p1, __p2, __p3, __p4) \
	LP5(30, int , Config_Settings, \
		Cfg_Environment *, __p0, a0, \
...
#define ShowPaletteBox(__p0, __p1, __p2, __p3, __p4, __p5, __p6) \
	LP7(96, long , ShowPaletteBox, \
		struct Window *, __p0, a0, \
		DOpusScreenData *, __p1, a1, \
		short *, __p2, a2, \
		short *, __p3, a3, \
		struct TextAttr *, __p4, a4, \
		ColourSpec32 *, __p5, a5, \
		short *, __p6, d0, \
		, CONFIGOPUS_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define Config_Environment(__p0, __p1, __p2, __p3, __p4, __p5, __p6, __p7, __p8) \
	LP9(36, unsigned long , Config_Environment, \
		Cfg_Environment *, __p0, a0, \
		struct Screen *, __p1, a1, \
		UWORD *, __p2, a2, \
		IPCData *, __p3, a3, \
...
#define EditFiletype(__p0, __p1, __p2, __p3, __p4) \
	LP5(84, Cfg_Filetype *, EditFiletype, \
...
#define Config_Menus(__p0, __p1, __p2, __p3, __p4, __p5, __p6) \
	LP7(78, ULONG , Config_Menus, \
		IPCData *, __p0, a0, \
		IPCData *, __p1, a1, \
		struct Screen *, __p2, a2, \
		Cfg_ButtonBank *, __p3, a3, \
		ULONG , __p4, d0, \
		ULONG , __p5, d1, \
		char *, __p6, d2, \
		, CONFIGOPUS_BASE_NAME, 0, 0, 0, 0, 0, 0)
