...
#define FreeSysInfo(__p0) \
	LP1NR(36, FreeSysInfo, \
		struct SysInfo *, __p0, a0, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define AddNotify(__p0, __p1, __p2) \
	LP3(78, struct SI_Notify *, AddNotify, \
		struct SysInfo *, __p0, a0, \
		WORD , __p1, d0, \
		LONG , __p2, d1, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define RemoveNotify(__p0, __p1) \
	LP2NR(84, RemoveNotify, \
		struct SysInfo *, __p0, a0, \
		struct SI_Notify *, __p1, a1, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define GetLoadAverage(__p0, __p1) \
	LP2NR(42, GetLoadAverage, \
		struct SysInfo *, __p0, a0, \
		struct SI_LoadAverage *, __p1, a1, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define InitSysInfo() \
	LP0(30, struct SysInfo *, InitSysInfo, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define GetCpuUsage(__p0, __p1) \
	LP2NR(90, GetCpuUsage, \
		struct SysInfo *, __p0, a0, \
		struct SI_CpuUsage *, __p1, a1, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define GetTaskCpuUsage(__p0, __p1, __p2) \
	LP3(96, LONG , GetTaskCpuUsage, \
		struct SysInfo *, __p0, a0, \
		struct SI_TaskCpuUsage *, __p1, a1, \
		struct Task *, __p2, a2, \
		, SYSINFO_BASE_NAME, 0, 0, 0, 0, 0, 0)
