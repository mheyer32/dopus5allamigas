...
#define GetNewDiskObject(name) ({ \
  ...
  ((struct NewDiskObject * (*)(char * __asm("a6"), UBYTE * __asm("a0"))) \
  (_GetNewDiskObject__bn - 30))(_GetNewDiskObject__bn, _GetNewDiskObject_name); \
});})
...
#define PutNewDiskObject(name, newdiskobj) ({ \
  ...
  (_PutNewDiskObject__bn - 36))(_PutNewDiskObject__bn, _PutNewDiskObject_name, _PutNewDiskObject_newdiskobj); \
});})
...
#define FreeNewDiskObject(newdiskobj) ({ \
  ...
  ((void (*)(char * __asm("a6"), struct NewDiskObject * __asm("a0"))) \
  (_FreeNewDiskObject__bn - 42))(_FreeNewDiskObject__bn, _FreeNewDiskObject_newdiskobj); \
});})
...
#define RemapChunkyImage(chunkyimage, screen) ({ \
  ...
  (_RemapChunkyImage__bn - 66))(_RemapChunkyImage__bn, _RemapChunkyImage_chunkyimage, _RemapChunkyImage_screen); \
});})
...
#define FreeRemappedImage(image, screen) ({ \
  ...
  (_FreeRemappedImage__bn - 72))(_FreeRemappedImage__bn, _FreeRemappedImage_image, _FreeRemappedImage_screen); \
});})
...
#define GetDefNewDiskObject(def_type) ({ \
  ...
  ((struct NewDiskObject * (*)(char * __asm("a6"), LONG __asm("d0"))) \
  (_GetDefNewDiskObject__bn - 78))(_GetDefNewDiskObject__bn, _GetDefNewDiskObject_def_type); \
});})
