...
ConfigWindow hotkeys_window = {{POS_CENTER, POS_CENTER, 64, 12}, {0, 0, 32, 70}},

			 scripts_window = {{POS_CENTER, POS_CENTER, 44, 8}, {0, 0, 28, 70}};

struct TagItem _lister_menu_layout[] = {{GTCustom_CopyTags, 1},
