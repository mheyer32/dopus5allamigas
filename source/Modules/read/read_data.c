	...
	read_menus[]={
		...
		{NM_TITLE,0,MSG_MENU_SETTINGS,0},
			...
			{NM_ITEM,0,MSG_MENU_MODE,0},
				{NM_SUB,MENU_MODE_NORMAL,MSG_MENU_MODE_NORMAL,CHECKIT|MENUFLAG_AUTO_MUTEX|MENUFLAG_USE_SEQ|MENUFLAG_MAKE_SEQ('O')},
				{NM_SUB,MENU_MODE_ANSI,MSG_MENU_MODE_ANSI,CHECKIT|MENUFLAG_AUTO_MUTEX|MENUFLAG_USE_SEQ|MENUFLAG_MAKE_SEQ('I')},
				{NM_SUB,MENU_MODE_HEX,MSG_MENU_MODE_HEX,CHECKIT|MENUFLAG_AUTO_MUTEX|MENUFLAG_USE_SEQ|MENUFLAG_MAKE_SEQ('H')},
			{NM_ITEM,0,NM_BAR_LABEL,0},
