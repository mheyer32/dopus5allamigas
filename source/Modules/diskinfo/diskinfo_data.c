...
ULONG
	disktype_lookup[]={
		...
		ID_FFS3_HARD,MSG_DOSTYPE_14,
		ID_FFS7_HARD,MSG_DOSTYPE_15,
		ID_SFS0_HARD,MSG_DOSTYPE_16,
		ID_SFS2_HARD,MSG_DOSTYPE_17,
		ID_JXFS_HARD,MSG_DOSTYPE_18,
		ID_SWAP_HARD,MSG_DOSTYPE_19,
		0,0};
