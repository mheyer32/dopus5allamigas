...
__asm L_StrConcat(register __a0 char *buf,
	...
	register __d0 int lim);
ULONG __asm L_Atoh(register __a0 unsigned char *,
	register __d0 short);
...
void __asm L_ConvertStartMenu(register __a0 Cfg_ButtonBank *);
...
void __asm L_UpdateEnvironment(register __a0 CFG_ENVR *);
...
long __asm L_CloseBuf(register __a0 APTR file);
...
struct Hook *__asm L_LockReqBackFill(
	register __a0 struct Screen *screen,
	register __a6 struct MyLibrary *libbase);
void __asm  L_UnlockReqBackFill(
	register __a6 struct MyLibrary *libbase);
...
BOOL __asm L_SavePos(
	register __a0 char *name,
	register __a1 struct IBox *box,
	register __d0 short fontsize);

BOOL __asm L_LoadPos(
	register __a0 char *name,
	register __a1 struct IBox *box,
	register __d0 short *fontsize);

void __asm L_SetConfigWindowLimits(
