...
static char *version="$VER: filetype.module "VERSION"."REVISION" "__AMIGADATE__;
...
{
int ok = FALSE;
KPrintF( "finder_create\n" );
KPrintF( "  &data->creator_ipc = 0x%08lx\n", &data->creator_ipc );
KPrintF( "  data->creator_ipc = 0x%08lx\n", data->creator_ipc );
KPrintF( "  data = %lx\n", data );
KPrintF( "  data->A4 = %lx\n", data->a4 );
KPrintF( "  A4 = %lx\n", getreg( REG_A4 ));
KPrintF( "  DOSBase = 0x%08lx\n", DOSBase );
...
{
ULONG ok = TRUE;
KPrintF( "creator_editor_proc_init\n" );
data->editor_ipc = ipc;
...
Cfg_Filetype *edited_filetype;
int ok = FALSE;
KPrintF( "creator_editor_proc_code\n" );
DOpusBase = (struct Library *)FindName( &((struct ExecBase *)*((ULONG *)4))->LibList, "dopus5.library" );
fred( 1 );
...
{
int ok = FALSE;
KPrintF( "creator_edit\n" );
KPrintF( "  &data->editor_ipc = 0x%08lx\n", &data->editor_ipc );
KPrintF( "  data->editor_ipc = 0x%08lx\n", data->editor_ipc );
KPrintF( "  DOSBase = 0x%08lx\n", DOSBase );
KPrintF( "  creator_editor_proc_code = 0x%08lx\n", creator_editor_proc_code );
KPrintF( "  data = 0x%08lx\n", data );
KPrintF( "  a4 = 0x%08lx\n", data->a4 );
KPrintF( "  a4 = 0x%08lx\n", getreg( REG_A4 ) );
