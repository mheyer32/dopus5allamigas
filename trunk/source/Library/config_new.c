...
Cfg_ButtonBank *LIBFUNC L_NewButtonBank(
	REG(d0, BOOL init),
	REG(d1, short type))
{
	Cfg_ButtonBank *bank;
...
Cfg_Button *LIBFUNC L_NewButtonWithFunc(
	REG(a0, APTR memory),
	REG(a1, char *label),
	REG(d0, short type))
{
...
// Create a new lister
Cfg_Lister *LIBFUNC L_NewLister(
	REG(a0, char *path))
{
	Cfg_Lister *lister;
...
Cfg_Function *LIBFUNC L_NewFunction(
	REG(a0, APTR memory),
	REG(d0, UWORD type))
{
...
Cfg_ButtonFunction *LIBFUNC L_NewButtonFunction(
	REG(a0, APTR memory),
	REG(d0, UWORD type))
{
...
Cfg_Instruction *LIBFUNC L_NewInstruction(
	REG(a0, APTR memory),
	REG(d0, short type),
	REG(a1, char *string))
{
