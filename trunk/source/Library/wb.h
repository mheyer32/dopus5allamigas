...
#define LIBCALL_7(ret,func,callbase,callface,r1,n1,r2,n2,r3,n3,r4,n4,r5,n5,r6,n6,r7,n7) \
	((ret ASM (*) (APTR __local_iface, REG(r1, ULONG), REG(r2, ULONG), REG(r3, ULONG), REG(r4, ULONG), REG(r5, ULONG), REG(r6, ULONG), REG(r7, ULONG)))func) \
...
#define LIBCALL_0(ret,func,callbase,dummy) \
	((ret ASM (*) (REG(a6, APTR)))func) \
	((APTR)callbase)

#define LIBCALL_1(ret,func,callbase,dummy,r1,n1) \
	((ret ASM (*) (REG(r1, ULONG), REG(a6, APTR)))func) \
	((ULONG)n1, (APTR)callbase)
...
#define LIBCALL_7(ret,func,callbase,dummy,r1,n1,r2,n2,r3,n3,r4,n4,r5,n5,r6,n6,r7,n7) \
	((ret ASM (*) (REG(r1, ULONG), REG(r2, ULONG), REG(r3, ULONG), REG(r4, ULONG), REG(r5, ULONG), REG(r6, ULONG), REG(r7, ULONG), REG(a6, APTR)))func) \
...
#define PATCHED_7(ret,name,r1,t1,n1,r2,t2,n2,r3,t3,n3,r4,t4,n4,r5,t5,n5,r6,t6,n6,r7,t7,n7) \
	ret name(REG(r1, t1 n1), REG(r2, t2 n2 ), REG(r3, t3 n3), REG(r4, t4 n4), REG(r5, t5 n5), REG(r6, t6 n6), REG(r7, t7 n7)) {
