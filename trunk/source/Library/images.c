...
BOOL LIBFUNC L_RemapImage(
	REG(a0, Image_Data *image),
	...
	REG(a2, ImageRemap *remap))
{
	...
	if (!image || ((struct Library *)GfxBase)->lib_Version<39) return 0; 
