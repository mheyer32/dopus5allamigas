...
if	((data->app_port = CreateMsgPort())
	...
	if	((data->notify_req = AddNotifyRequest(
		...
		#ifdef __amigaos4__
		INewIcon=(struct NewIconIFace *)GetInterface(data->newicon_base,"main",1,NULL); 
		#endif
...
if	((draginf = GetDragInfo(
	...
	DrawIconState(
		&draginf->drag_rp, data->icon, NULL, 
		0, 0, data->image_num ? IDS_SELECTED : IDS_NORMAL, 
...
#ifdef USE_DRAWICONSTATE
{
	...
	if (GetIconRectangle(
		data->window->RPort, data->icon, NULL, &rect, 
		ICONDRAWA_Borderless, TRUE, 
		TAG_DONE))
	{
...
#ifdef USE_DRAWICONSTATE
DrawIconState(
	data->window->RPort, data->icon, NULL, 
	x+data->icon_area.MinX, y+data->icon_area.MinY, data->image_num ? IDS_SELECTED : IDS_NORMAL, 
	ICONDRAWA_Frameless,       TRUE,
	ICONDRAWA_Borderless,      TRUE,
