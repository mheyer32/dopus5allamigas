...
unsigned long
	filesystem_table[]={
		...
		ID_PFS_FLOPPY,MSG_PFS1,
		ID_PFS_HARD,MSG_PFS1,
		ID_PFS2_DISK,MSG_PFS2,
		ID_PFS3_DISK,MSG_PFS3,  
		ID_PFS2_SC_DISK,MSG_PFS2,
		ID_PFS3_SC_DISK,MSG_PFS3,
		ID_PFS3_MULTI,MSG_PFS3_MULTI,
		ID_DOS_DISK,MSG_OFS,
		ID_FFS_DISK,MSG_FFS,
		...
		ID_FFS7_DISK,MSG_FFS7,
		ID_VP255_DISK,MSG_VP255,
		ID_SFS0_DISK,MSG_SFS0,
		ID_SFS1_DISK,MSG_SFS1,
		ID_SFS2_DISK,MSG_SFS2,
		ID_SFS3_DISK,MSG_SFS3,
		ID_JXFS_DISK,MSG_JXFS,		
		ID_BOX0_DISK,MSG_BOX,
		ID_FAT32_DISK,MSG_FAT32,
		ID_EXFAT_DISK,MSG_EXFAT,
		ID_EXT2_DISK,MSG_EXT2FS,
		ID_HFS_DISK,MSG_HFS,
		ID_NTFS_DISK,MSG_NTFS,
		ID_SWAP_DISK,MSG_SWAP,
		0,MSG_UNKNOWN};
