...
#define libvector 	LFUNC_FAS(L_Config_Settings) \
					LFUNC_FA_(L_Config_Environment) \
					,LibNull \
					LFUNC_FA_(L_Config_Buttons) \
					LFUNC_FA_(L_ConvertConfig) \
					LFUNC_FA_(L_Config_Filetypes) \
					LFUNC_FA_(L_Config_ListerButtons) \
					LFUNC_FA_(L_Config_Menu) \
					LFUNC_FA_(L_Config_Menus) \
					LFUNC_FA_(L_EditFiletype) \
					LFUNC_FA_(L_Config_EditFunction) \
					LFUNC_FA_(L_ShowPaletteBox) \
