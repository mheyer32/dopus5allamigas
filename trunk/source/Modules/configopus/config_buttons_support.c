...
void palette_editor_init(PaletteBoxData *data)
{
	...
	data->stuff.stuff1.palette_tags[0].ti_Data=data->screen_data.pen_count+((((struct Library*)GfxBase)->lib_Version>=39)?8:4);
	...
	CopyMem(
		...
		(char *)data->stuff.stuff1.object_def,
		sizeof(data->stuff.stuff1.object_def));
