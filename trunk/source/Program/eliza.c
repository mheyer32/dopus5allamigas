...
void eliza_decrypt_string(unsigned char *);
...
#if 0
void eliza_decrypt_string(unsigned char *string)
{
	short num;
...
void eliza_decrypt(void)
{
	...
	for (num=0;*keyword[num];num++)
		eliza_decrypt_string(keyword[num]);

	for (num=0;*wordin[num];num++)
		eliza_decrypt_string(wordin[num]);

	for (num=0;*wordout[num];num++)
		eliza_decrypt_string(wordout[num]);

	for (num=0;*replies[num];num++)
		eliza_decrypt_string(replies[num]);
