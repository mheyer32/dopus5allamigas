...
#define DivideToString64(string, str_size, bytes, div, places, sep) IDOpus->DivideToString64((string), (str_size), (bytes), (div), (places), (sep)) 
#define BytesToString64(bytes, string, str_size, places, sep) IDOpus->BytesToString64((bytes), (string), (str_size), (places), (sep)) 
