...
#define InitSysInfo() ({ \
  ...
  ((struct SysInfo * (*)(char * __asm("a6"))) \
  (_InitSysInfo__bn - 30))(_InitSysInfo__bn); \
})
...
#define FreeSysInfo(si) ({ \
  ...
  ((void (*)(char * __asm("a6"), struct SysInfo * __asm("a0"))) \
  (_FreeSysInfo__bn - 36))(_FreeSysInfo__bn, _FreeSysInfo_si); \
});})
...
#define GetPid(si) ({ \
  ...
  ((LONG (*)(char * __asm("a6"), struct SysInfo * __asm("a0"))) \
  (_GetPid__bn - 48))(_GetPid__bn, _GetPid_si); \
});})
...
#define GetPpid(si) ({ \
  ...
  ((LONG (*)(char * __asm("a6"), struct SysInfo * __asm("a0"))) \
  (_GetPpid__bn - 54))(_GetPpid__bn, _GetPpid_si); \
});})
...
#define GetPgrp(si) ({ \
  ...
  ((LONG (*)(char * __asm("a6"), struct SysInfo * __asm("a0"))) \
  (_GetPgrp__bn - 60))(_GetPgrp__bn, _GetPgrp_si); \
});})
...
#define SetNice(si, which, who, nice) ({ \
  ...
  ((LONG (*)(char * __asm("a6"), struct SysInfo * __asm("a0"), LONG __asm("d0"), LONG __asm("d1"), LONG __asm("d2"))) \
  (_SetNice__bn - 72))(_SetNice__bn, _SetNice_si, _SetNice_which, _SetNice_who, _SetNice_nice); \
});})
...
#define AddNotify(si, flags, safety_limit) ({ \
  ...
  ((struct SI_Notify * (*)(char * __asm("a6"), struct SysInfo * __asm("a0"), WORD __asm("d0"), LONG __asm("d1"))) \
...
#define GetTaskCpuUsage(si, usage, task) ({ \
  ...
  ((LONG (*)(char * __asm("a6"), struct SysInfo * __asm("a0"), struct SI_TaskCpuUsage * __asm("a1"), struct Task * __asm("a2"))) \
  (_GetTaskCpuUsage__bn - 96))(_GetTaskCpuUsage__bn, _GetTaskCpuUsage_si, _GetTaskCpuUsage_usage, _GetTaskCpuUsage_task); \
});})
