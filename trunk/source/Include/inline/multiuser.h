...
#define muLogoutA(taglist) ({ \
  ...
  (_muLogoutA__bn - 30))(_muLogoutA__bn, _muLogoutA_taglist); \
});})
...
#define muLoginA(taglist) ({ \
  ...
  ((ULONG (*)(char * __asm("a6"), struct TagItem * __asm("a0"))) \
  (_muLoginA__bn - 36))(_muLoginA__bn, _muLoginA_taglist); \
});})
...
#define muGetTaskOwner(task) ({ \
  ...
  ((ULONG (*)(char * __asm("a6"), struct Task * __asm("d0"))) \
  (_muGetTaskOwner__bn - 42))(_muGetTaskOwner__bn, _muGetTaskOwner_task); \
});})
...
#define muPasswd(oldpwd, newpwd) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), STRPTR __asm("a0"), STRPTR __asm("a1"))) \
  (_muPasswd__bn - 48))(_muPasswd__bn, _muPasswd_oldpwd, _muPasswd_newpwd); \
});})

#define muAllocUserInfo() ({ \
  register char * _muAllocUserInfo__bn __asm("a6") = (char *) (MULTIUSER_BASE_NAME);\
  ((struct muUserInfo * (*)(char * __asm("a6"))) \
  (_muAllocUserInfo__bn - 54))(_muAllocUserInfo__bn); \
})
...
#define muFreeUserInfo(info) ({ \
  ...
  ((void (*)(char * __asm("a6"), struct muUserInfo * __asm("a0"))) \
  (_muFreeUserInfo__bn - 60))(_muFreeUserInfo__bn, _muFreeUserInfo_info); \
});})
...
#define muSetDefProtectionA(taglist) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct TagItem * __asm("a0"))) \
  (_muSetDefProtectionA__bn - 78))(_muSetDefProtectionA__bn, _muSetDefProtectionA_taglist); \
});})
...
#define muGetDefProtection(task) ({ \
  ...
  ((ULONG (*)(char * __asm("a6"), struct Task * __asm("d0"))) \
  (_muGetDefProtection__bn - 84))(_muGetDefProtection__bn, _muGetDefProtection_task); \
});})
...
#define muSetProtection(name, mask) ({ \
  ...
  (_muSetProtection__bn - 90))(_muSetProtection__bn, _muSetProtection_name, _muSetProtection_mask); \
});})
...
#define muLimitDOSSetProtection(flag) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), BOOL __asm("d0"))) \
  (_muLimitDOSSetProtection__bn - 96))(_muLimitDOSSetProtection__bn, _muLimitDOSSetProtection_flag); \
});})
...
#define muCheckPasswd(taglist) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct TagItem * __asm("a0"))) \
  (_muCheckPasswd__bn - 102))(_muCheckPasswd__bn, _muCheckPasswd_taglist); \
});})
...
#define muGetPasswdDirLock() ({ \
  ...
  ((BPTR (*)(char * __asm("a6"))) \
  (_muGetPasswdDirLock__bn - 114))(_muGetPasswdDirLock__bn); \
})

#define muGetConfigDirLock() ({ \
  register char * _muGetConfigDirLock__bn __asm("a6") = (char *) (MULTIUSER_BASE_NAME);\
  ((BPTR (*)(char * __asm("a6"))) \
  (_muGetConfigDirLock__bn - 120))(_muGetConfigDirLock__bn); \
})
...
#define muGetTaskExtOwner(task) ({ \
  ...
  ((struct muExtOwner * (*)(char * __asm("a6"), struct Task * __asm("d0"))) \
  (_muGetTaskExtOwner__bn - 126))(_muGetTaskExtOwner__bn, _muGetTaskExtOwner_task); \
});})
...
#define muFreeExtOwner(info) ({ \
  ...
  ((void (*)(char * __asm("a6"), struct muExtOwner * __asm("a0"))) \
  (_muFreeExtOwner__bn - 132))(_muFreeExtOwner__bn, _muFreeExtOwner_info); \
});})
...
#define muGetRelationshipA(user, owner, taglist) ({ \
  ...
  ((ULONG (*)(char * __asm("a6"), struct muExtOwner * __asm("d0"), ULONG __asm("d1"), struct TagItem * __asm("a0"))) \
  (_muGetRelationshipA__bn - 138))(_muGetRelationshipA__bn, _muGetRelationshipA_user, _muGetRelationshipA_owner, _muGetRelationshipA_taglist); \
});})

#ifndef NO_INLINE_STDARG
static __inline__ ULONG ___muGetRelationship(struct Library * muBase, struct muExtOwner * user, ULONG owner, ULONG taglist, ...)
{
...
#define muAllocGroupInfo() ({ \
  ...
  ((struct muGroupInfo * (*)(char * __asm("a6"))) \
  (_muAllocGroupInfo__bn - 150))(_muAllocGroupInfo__bn); \
})
...
#define muFreeGroupInfo(info) ({ \
  ...
  ((void (*)(char * __asm("a6"), struct muGroupInfo * __asm("a0"))) \
  (_muFreeGroupInfo__bn - 156))(_muFreeGroupInfo__bn, _muFreeGroupInfo_info); \
});})
...
#define muAddMonitor(monitor) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct muMonitor * __asm("a0"))) \
  (_muAddMonitor__bn - 168))(_muAddMonitor__bn, _muAddMonitor_monitor); \
});})
...
#define muRemMonitor(monitor) ({ \
  ...
  ((void (*)(char * __asm("a6"), struct muMonitor * __asm("a0"))) \
  (_muRemMonitor__bn - 174))(_muRemMonitor__bn, _muRemMonitor_monitor); \
});})
...
#define muKill(task) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct Task * __asm("d0"))) \
  (_muKill__bn - 180))(_muKill__bn, _muKill_task); \
});})
...
#define muFreeze(task) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct Task * __asm("d0"))) \
  (_muFreeze__bn - 186))(_muFreeze__bn, _muFreeze_task); \
});})
...
#define muUnfreeze(task) ({ \
  ...
  ((BOOL (*)(char * __asm("a6"), struct Task * __asm("d0"))) \
  (_muUnfreeze__bn - 192))(_muUnfreeze__bn, _muUnfreeze_task); \
});})
